...
<body>
<div class="cp_title">混合推荐预测榜单</div>
<div class="add_cp">
    <form action="${ctx}/hybrid/getHybridRecResult" method="get">
        <div id="queryDiv">
...
<script type="text/javascript">
    ...
    function prePage(currentPage) {
        window.location = "${ctx}/hybrid/getHybridRecResult?pageNum=" + (currentPage - 1) + "&userno=" + '${user}';
    }
